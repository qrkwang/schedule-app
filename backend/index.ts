...
app.post('/events/user/create/', async (req, res) => {
    ...
    try {
        ...
        if (recurrence) {
            ...
            let newDateFrom = dateFrom; //start with initial dateFrom
            let newDateTo = dateTo; // start with initial dateTo
            ...
            if (recurrence === "weekly") {
                ...
                for (let i = 0; i < 12; i++) {
                    ...
                    console.log("current dateFrom", newDateTo);

                    //Iterate the dates to next month
                    newDateFrom = new Date(newDateFrom);
                    console.log("current newdatefrom");
                    newDateFrom.setMonth(newDateFrom.getMonth() + 1);
                    console.log("after change newdatefrom", newDateFrom);
                    newDateTo = new Date(newDateTo);
                ...
                for (let i = 0; i < 5; i++) {
                    //Iterate the dates to next year
                    newDateFrom = new Date(newDateFrom);
                ...
                res.status(400).send("Invalid recurrence string");
            }
